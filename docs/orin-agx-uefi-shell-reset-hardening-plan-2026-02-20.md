...
- Mirror docs in `/home/hlyytine/tii-sel4/projects/virtioso-camkes-vm` are updated in same rollout

## Global guardrails (run before each step)
- SSOT/DRY lint:
  - `bash /home/hlyytine/tii-sel4/projects/virtioso-camkes-vm/docs/agents/lint-ssot.sh`
- Python syntax:
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S1 | Create tracking artifact | `docs/orin-agx-uefi-shell-reset-hardening-plan-2026-02-20.md` | global guardrails | `git diff -- docs/orin-agx-uefi-shell-reset-hardening-plan-2026-02-20.md` | `docs: add Orin UEFI shell reset hardening progress plan` | in_progress | - |
| S2 | Add explicit reset-line API | `BoardControl.py` | global guardrails | `python3 -m py_compile BoardControl.py` | `board: add explicit reset line control methods` | pending | - |
