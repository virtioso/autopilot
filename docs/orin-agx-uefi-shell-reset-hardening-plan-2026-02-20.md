...
| S4 | Fix chain entry drift | `chains/boot_stock_linux.json` | global guardrails | chain validation via daemon startup path | `chains: fix boot_stock_linux entry flow` | in_progress | - |
