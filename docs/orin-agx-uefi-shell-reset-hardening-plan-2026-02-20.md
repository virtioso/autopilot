...
| S5 | Autopilot docs sync | `docs/chain-spec.md`, `docs/runbook.md`, `docs/README.md`, `docs/architecture.md`, `docs/boot-sequence.md` | global guardrails | targeted `rg` checks for stale behavior text | `docs: align autopilot boot flow docs with Orin shell sequence` | in_progress | - |
